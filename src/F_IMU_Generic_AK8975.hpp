...
#ifndef _F_IMU_Generic_AK8975_H_
#define _F_IMU_Generic_AK8975_H_
...
public:
	...
	String IMUName() override {
		return "Generic + AK8975";
	}
	String IMUType() override {
		return "IMU_Generic_AK8975";
	}
	String IMUManufacturer() override {
		return "Counterfeit IMU + AKM";
	}
...
#endif /* _F_IMU_Generic_AK8975_H_ */
