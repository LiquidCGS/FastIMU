...
#ifndef _F_MPU6500_H_
#define _F_MPU6500_H_
...
public:
	...
	int init(calData cal, uint8_t address = MPU6500_DEFAULT_ADDRESS) override;
...
private:
	...
	bool dataAvailable(){ return (readByteI2C(wire, IMUAddress, MPU6500_INT_STATUS) & 0x01);}
};
#endif /* _F_MPU6500_H_ */
