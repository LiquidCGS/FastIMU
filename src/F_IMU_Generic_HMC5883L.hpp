...
#ifndef _F_IMU_Generic_HMC5883L_H_
#define _F_IMU_Generic_HMC5883L_H_
...
public:
	...
	String IMUName() override {
		return "Generic + HMC5883L";
	}
	String IMUType() override {
		return "IMU_Generic_HMC5883L";
	}
	String IMUManufacturer() override {
		return "Counterfeit IMU + Bosch";
	}
...
#endif /* _F_IMU_Generic_HMC5883L_H_ */
